        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com/apoorvaroyale" target="_blank" rel="noopener noreferrer" 
                 className="w-10 h-10 bg-[#ad8b3a]/20 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all duration-300 group">
              ...
              <a href="https://instagram.com/apoorvaroyale" target="_blank" rel="noopener noreferrer" 
                 className="w-10 h-10 bg-[#ad8b3a]/20 rounded-full flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 transition-all duration-300 group">
                <svg className="w-5 h-5 text-[#ad8b3a] group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://youtube.com/@apoorvaroyale" target="_blank" rel="noopener noreferrer" 
                 className="w-10 h-10 bg-[#ad8b3a]/20 rounded-full flex items-center justify-center hover:bg-red-600 transition-all duration-300 group">
                <svg className="w-5 h-5 text-[#ad8b3a] group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="https://wa.me/919668821100" target="_blank" rel="noopener noreferrer" 
                 className="w-10 h-10 bg-[#ad8b3a]/20 rounded-full flex items-center justify-center hover:bg-green-500 transition-all duration-300 group">
                <svg className="w-5 h-5 text-[#ad8b3a] group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/contact" className="text-stone-300 hover:text-[#ad8b3a] transition-colors duration-300">Contact Us</Link></li>
              <li><Link href="/about-us" className="text-stone-300 hover:text-[#ad8b3a] transition-colors duration-300">About Us</Link></li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <Link href="/contact" className="text-stone-300 hover:text-[#ad8b3a] transition-colors duration-300">
                  +91 96688 21100
                </Link>
              </div>              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#ad8b3a] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <Link 
                  href="/contact"
                  className="text-stone-300 hover:text-green-400 transition-colors duration-300"
                >
                  WhatsApp Booking
                </Link>
              </div>              <div className="flex items-center space-x-3">
