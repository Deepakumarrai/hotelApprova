          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:pl-12">              {/* Professional Badge */}
              ...
              <div className="space-y-4">
                <a 
                  href="https://wa.me/919668821100?text=Hi! I would like to book a room at Apoorva Royale Hotel. Please help me with the booking process." 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group relative w-full lg:w-auto overflow-hidden bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-xl text-base font-semibold tracking-wide transition-all duration-300 shadow-xl hover:shadow-green-500/30 hover:scale-105 flex items-center justify-center space-x-2"
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-green-500 transform translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
                </a>

                <div className="flex flex-col lg:flex-row gap-3">
                  <a 
                    href="tel:+919668821100" 
                    className="group border-2 border-[#ad8b3a] text-[#ad8b3a] px-6 py-3 rounded-xl text-sm font-medium tracking-wide hover:bg-[#ad8b3a] hover:text-white transition-all duration-300 flex items-center justify-center space-x-2"
                  >
                  ...
                  <a 
                    href="/contact" 
                    className="group border-2 border-yellow-600 text-yellow-700 px-6 py-3 rounded-xl text-sm font-medium tracking-wide hover:bg-yellow-600 hover:text-white transition-all duration-300 flex items-center justify-center space-x-2"
                  >
